...
namespace AutoChat
{
    class Program
    {
        ...
        static void setupMessages()
        {
            ...
            {
                "gj", "gj", "gj", "gj", "good job", "wp", "nice", "goodjob", "gjwp", "nice one", "awesome"
            };
            ...
            {
                "sorry guys", "sorry", "soz", "my bad"
            };

            Sympathy = new List<string>
            {
                "bl", "bl", "tough luck", "bad luck", "unlucky"
            };

            Clutch = new List<string>
            {
                "hahaha", "NICE", "GJ", "WELL DONE", "HAHA", "epic", "REKT", "GG"
            };

            Motivate = new List<string>
            {
                "we got this", "play safe fellas" , "focus objectives", "lets group"
            };

            Honor = new List<string>
            {
                "wp" ,"wp" ,"wp mate", "wp dude", "wp man"
            };
        }
        #endregion
